...
<html lang="fr">
  ...
  <!-- ========================================= -->
    ...
    <div class="col-sm-12 col-md-4">
        <h2>Les variables</h2>
        <p>Chaque variable possède un identifiant particulier, qui commence toujours par le caractère dollar ($) suivi du  nom de la variable. Les règles de création des noms de variables sont les suivants :</p>
        <ul>
    ...
    <div class="col-sm-12 col-md-4">
        <ul>
            <li><li>La longueur du nom n'est pas limitée, mais il convient d'être raisonnable sous peine de confusion dans la saisie du code. Il est conseillé de créer des noms de variable le plus « parlant » possible. En relisant le code contenant la variable $nomclient, par exemple, vous comprenez davantage ce que vous manipulez que si vous aviez écrit $x ou $y.</li></li>
        </ul>
    ...
    <div class="col-sm-12 col-md-4">
        <ul>
            <li><li>La déclaration des variables n'est pas obligatoire en début de script. C'est là une différence notable avec les langages fortement typés comme Java ou C. Vous pouvez créer des variables n'importe où, à condition bien sûr de les créer avant de les utiliser, même s'il reste possible d'appeler une variable qui n'existe pas sans provoquer d'erreur.</li></li>
    ...
    <div class="col-sm-12">
        ...
        <p>L'affectation consiste à donner une valeur à une variable. Lors de la création d'une variable, vous ne déclarez pas son type. C'est une valeur que vous lui affectez qui détermine ce type. Dans PHP, vous pouvez affecter une variable par valeur ou par référence</p>
        <ul>
            <li>$mavar=75;</li>
            <li>$mavar="Paris";</li>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <p>PHP dispose d'un grand nombre de variables prédéfinies, qui contiennent des informations à la fois sur le serveur et sur toutes les données qui peuvent transiter entre le poste client et le serveur, comme les valeurs saisies dans un formulaire, les cookies ou les session.</p>
        </div>
    </div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td scope="row">$_Request</td>
                    <td>Contient l'ensemble des variables superglobales $_GET, $POST, $_COOKIE et $_FILES</td>
                </tr>
                <tr>
        ...
        <div class="col-sm-12">
            ...
            <p>En plus de l'pérateur classique d'affectation=, il existe plusieurs opérateurs d'affectation combiné.Ces opérateurs réalisent à la fois une opération entre deux opérandes</p>
        </div>
        ...
        <table class="table table-striped">
					...
					<p>On peut définir ses constantes soi-même cf. ; Pour définir des constantes personnalisées, utilisez la fonction define(), dont la syntaxe est la suivante : <strong>boolean define(string nom_cte, divers valeur_cte, boolean casse)</strong> Voir la page <a href="../exemples_pages/03_pages.php">suivante</a></p>
                    </div>

                    <h3>Les constantes prédéfinies</h3>
                    <p><p>Il existe dans PHP un grand nombre de constantes prédéfinies, que vous pouvez notamment utiliser dans les fonctions comme paramètres permettant de définir des options. Nous ne pouvons les citer toutes tant elles sont nombreuses, mais nous les définirons au fur et à mesure de nos besoins. Voir la page <a href="#">avec un exemple</a></p></p>

        ...
        <div class="row bg-light p-3">
            <div class="col-sm-12 col-md-4">
                ...
                echo "<p class=\"alert alert-success w-75 mx-auto text-center\">";
                    ...
                    $c = 25;
                    if($a > $b && $b > $c) {
                        echo "Les deux conditions sont ok";
                    }
                    echo "</p>";
                ?>
            </div><!-- fin col -->
            <div class="col-sm-12 col-md-4">
                ...
                if( $a > $b){
                    ...
                    echo "<p class=\"text-success\"> $b est supérieur à $a";
                }
                echo "</p>";
                ...
                if ($e == 9 || $f > $g){
                    ...
                    echo "Les deuc conditions sont fausses";
                }
                echo "</p>";
                
                ?> 

                <p>Le bloc qui suit les instructions if ou else peut contenir toute sortes d'instructions, y compris d'autres instruction <code>if..else</code>.Nous obtenons dans ce cas une syntaxe plus complexe, de la forme : VOIR</p>
            </div><!-- fin col -->
            ...
            <div class="col-sm-12 col-md-4">
                ...
                <p>Le bloc qui suit les instruction if ou else peut contenir toute sorte d'instruction, y compris d'autres instructions <code>if...else</code></p>
                ...
                <?php 
                 ...
                 if ($h == 10){
                     ...
                     echo "$h est différdnt de 10";
                 }

                 // La même en ternaire
                 echo ($h == 10 ) ? "$h est égal à 10": "$h est différent de 10"; //si $h est égal a 10, on affiche la premiere expression sinon la seconde
                ?> 
